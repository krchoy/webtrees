...
class Theme {
	...
	/**
	 * Set the current theme for the request
	 */
	...
	public static function theme() {
		// @TODO: Temporary - until we move the initialisation code from session.php to Theme:init()
		global $WT_THEME; return $WT_THEME;
